...
# Название файла шаблона конфигурации турнира
EJUDGE_CONTEST_CONFIG_TEMPLATE_FILE_NAME = 'serve.cfg'

# Название файла шаблона описания турнира
EJUDGE_CONTEST_DESCRIPTION_TEMPLATE_FILE_NAME = 'contest.xml'

EJUDGE_PROBLEM_CONFIG_TEMPLATE_FILE_ABSOLUTE_PATH = os.path.join(
    EJUDGE_CONFIG_TEMPLATES_DIR_ABSOLUTE_PATH,
    EJUDGE_PROBLEM_CONFIG_TEMPLATE_FILE_NAME
)

EJUDGE_PROBLEM_CONFIG_TEMPLATE_FILE_LOCAL_PATH = os.path.join(
    EJUDGE_CONFIG_TEMPLATES_DIR_LOCAL_PATH,
    EJUDGE_PROBLEM_CONFIG_TEMPLATE_FILE_NAME
)

EJUDGE_PROBLEM_DESCRIPTION_TEMPLATE_FILE_ABSOLUTE_PATH = os.path.join(
    EJUDGE_CONFIG_TEMPLATES_DIR_ABSOLUTE_PATH,
    EJUDGE_PROBLEM_DESCRIPTION_TEMPLATE_FILE_NAME
)

EJUDGE_PROBLEM_DESCRIPTION_TEMPLATE_FILE_LOCAL_PATH = os.path.join(
    EJUDGE_CONFIG_TEMPLATES_DIR_LOCAL_PATH,
    EJUDGE_PROBLEM_DESCRIPTION_TEMPLATE_FILE_NAME
)

EJUDGE_CONTEST_CONFIG_TEMPLATE_FILE_ABSOLUTE_PATH = os.path.join(
    EJUDGE_CONFIG_TEMPLATES_DIR_ABSOLUTE_PATH,
    EJUDGE_CONTEST_CONFIG_TEMPLATE_FILE_NAME
)

EJUDGE_CONTEST_CONFIG_TEMPLATE_FILE_LOCAL_PATH = os.path.join(
    EJUDGE_CONFIG_TEMPLATES_DIR_LOCAL_PATH,
    EJUDGE_CONTEST_CONFIG_TEMPLATE_FILE_NAME
)

EJUDGE_CONTEST_DESCRIPTION_TEMPLATE_FILE_ABSOLUTE_PATH = os.path.join(
    EJUDGE_CONFIG_TEMPLATES_DIR_ABSOLUTE_PATH,
    EJUDGE_CONTEST_DESCRIPTION_TEMPLATE_FILE_NAME
)

EJUDGE_CONTEST_DESCRIPTION_TEMPLATE_FILE_LOCAL_PATH = os.path.join(
    EJUDGE_CONFIG_TEMPLATES_DIR_LOCAL_PATH,
    EJUDGE_CONTEST_DESCRIPTION_TEMPLATE_FILE_NAME
)
